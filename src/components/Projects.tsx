        ...
        <div key={p.title} className="border-t border-black/10 py-12 first:border-t-0 first:pt-0">
          <div className="flex flex-row items-start gap-6 md:gap-10">
            <div className="flex flex-1 flex-col gap-3">
              ...
              <p className="max-w-xl text-sm leading-relaxed text-body">{p.description}</p>
            ...
            <div className="flex shrink-0 flex-col items-end gap-4">
              <span className="flex items-center gap-1.5 rounded-full border border-black/15 px-3 py-1">
              ...
              <span className="font-heading text-6xl font-bold leading-none text-black/10 md:text-7xl">
