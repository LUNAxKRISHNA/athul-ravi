...
export const proposalsUnderReview = [
  'Co-Principal Investigator (with Dr. Arya R as PI) on a proposal for CBSC-CVV empanelment as a Technology Support Provider under the World Bank-assisted RAMP programme (Intervention K2), focused on AI-based image processing for quality control in Kerala’s manufacturing MSMEs — currently under review.',
]
